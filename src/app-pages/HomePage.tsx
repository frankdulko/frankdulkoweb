  ...
  return (
    <div className={styles.App}>
      <div className={styles.about}>
        ...
        creative coding, and user-centered design. <br />
        <br /> Along the way, I’ve led end-to-end app development, built intuitive interfaces, and
        optimized performance for a range of startups and organizations. I invite you to explore my
        work below and get in touch with any questions or opportunities. I’m always excited to
        collaborate and keep pushing what’s possible with digital experiences.
