export const projects = [
    {
        ...
        "title": "Audacy.com",
        "path": "audacy",
        "description": "In the summer of 2022, I interned at Work & Co as a web developer implmenting the redesign of Audacy.com",
    ...
    },
    {
        ...
        "title": "Hop! - Social",
        "path": "hop-social",
        "description": "A social media application developed for iOS in order to chat with people at different nightlife locations around you.",
        "about": "Hop! is a location-based social media application I am developing that is currently beta testing. The intent is to see social locations in the immediate area, and be able to make posts relevant to the locations as well as chat with other people at these locations. The application is currently only available on iOS 14.0 and higher. It was developed with Swift, SwiftUI, and Firebase. If you would like to participate in the beta testing, check out the link below!",
        "images": [
            "/images/hop.jpg"
        ],
        "url": "https://testflight.apple.com/join/Z0B7L6Kp",
    ...
    },
    {
        ...
        "description": "A website to view all the government representatives for a given address in the United States.",
        "about": "Using Google’s Civic Information API, I designed and developed a dynamic and responsive webpage to display the federal, state, and local representatives for any given address in the United States of America. To accomplish this, I used Bootstrap, Javascript, and Node. The result can be viewed and interacted by clicking the button below. I believe it is important for everyone to know their government representatives, and I wanted to create an easy and clear way to view these individuals.",
        "images": [
            "/images/representatives.jpg"
        ],
